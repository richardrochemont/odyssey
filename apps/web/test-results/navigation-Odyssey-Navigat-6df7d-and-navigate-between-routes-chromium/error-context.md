...
- Name: navigation.spec.ts >> Odyssey Navigation and App Shell E2E Tests >> should display active top-navigation state and navigate between routes
...
- main [ref=f1e2]:
  - generic [ref=f1e3]:
    - generic [ref=f1e4]:
      - heading "Odyssey" [level=1] [ref=f1e9]
      - paragraph [ref=f1e10]: Sign in to manage your properties
    - generic [ref=f1e11]:
      - generic [ref=f1e12]:
        - text: Email Address
        - textbox "name@company.com" [ref=f1e18]
      - generic [ref=f1e19]:
        - text: Password
        - textbox "••••••••" [ref=f1e25]
      - button "Sign In" [ref=f1e26]
    - button "Don't have an account? Sign Up" [ref=f1e28]
```
