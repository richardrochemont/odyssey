...
- Name: navigation.spec.ts >> Odyssey Navigation and App Shell E2E Tests >> Money desktop flyout >> has correct accessible semantics and reachable menu items
- Location: e2e/navigation.spec.ts:280:9
...
- generic [active] [ref=e1]:
  - main [ref=e2]:
    - generic [ref=e3]:
      - generic [ref=e4]:
        - heading "Odyssey" [level=1] [ref=e9]
        - paragraph [ref=e10]: Sign in to manage your properties
      - generic [ref=e11]:
        - generic [ref=e12]: "Error:"
        - generic [ref=e13]: InternalServerError
      - generic [ref=e14]:
        - generic [ref=e15]:
          - generic [ref=e16]: Email Address
          - textbox "name@company.com" [ref=e18]: owner@odyssey.com
        - generic [ref=e19]:
...
> 17  |   await page.waitForURL("**/");
  ...
  115 |     await expect(page.locator('[data-testid="add-btn"]')).toBeVisible();
  116 | 
  117 |     await page.locator('[data-testid="add-btn"]').click();
```